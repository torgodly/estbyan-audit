    ...
    <section class="reg-login-shell">
        ...
        <div class="reg-login-card">
            ...
            <div class="mb-6 rounded-2xl border border-slate-100 bg-slate-50/80 px-4 py-3 text-center">
                ...
                <p class="mt-1 text-xs leading-relaxed text-slate-500">أدخل الرقم الآلي والرقم الوطني للتحقق من هويتك</p>
            </div>

            <div class="space-y-4">
                <div>
                    <label class="reg-label" for="empNumber">الرقم الآلي <span class="reg-required">*</span></label>
